...
import static org.gradle.api.internal.artifacts.dsl.DefaultRepositoryHandler.GOOGLE_REPO_NAME
...
class RepoScriptBlockUtil {
    ...
    private static enum MirroredRepository {
        ...
        GOOGLE(GOOGLE_REPO_NAME, System.getProperty('org.gradle.integtest.mirrors.google'), "maven"),
    ...
    static File createMirrorInitScript() {
        ...
        def mirrorConditions = MirroredRepository.values().collect { MirroredRepository mirror ->
            """
                if (repo.url == '${mirror.originalUrl}') {
